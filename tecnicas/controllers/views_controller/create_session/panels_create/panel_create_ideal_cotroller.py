...
class PanelCreateIdealController(PanelCreateController):
    names_tags = [
        ...
        if request.POST.get('action') == 'create_session':
            ...
            try:
                with transaction.atomic():
                    ...
                    # //////////////////////////////////////////////////////// #
                    #
                    # Fourth step: Create scales and relat with the technique #
                    #
                    # //////////////////////////////////////////////////////// #
                    size_scale = 9

                    intens_scale = Escala.objects.create(
                    ...
                    if not intens_scale:
                        raise ValueError(
                            "Error al crear la escala estructurada")

                    ideal_scale = Escala.objects.create(
                        id_tipo_escala=TipoEscala.objects.get(
                            nombre_escala="ideal"),
                        longitud=size_scale,
                        tecnica=technique
                    ...
                    # /////////////////////////////////////////////////////// #
                    #
                    # Fifth step: Create session and relat with the technique #
                    #
                    # /////////////////////////////////////////////////////// #
